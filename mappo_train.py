    ...
    def evaluate_policy(self, ):
        ...
        for _ in range(self.args.evaluate_times):
            episode_reward, _, episode_order_number, episode_income, episode_accepted_order_number, \
                ...
                episode_total_data_vol, episode_total_AOI, episode_total_data_utility = self.run_episode_mpe(
                evaluate=True)
        ...
        evaluate_total_AOI = evaluate_total_AOI / float(self.args.evaluate_times)
        ...
        print(
            "total_steps:{} \t evaluate_reward:{} \t evaluate_income:{} \t evalute_accepted_order_number:{} \t evaluate_collected_POI_number:{} \t evaluate_total_data_vol:{} \t evaluate_total_data_utility:{}".format(
                self.total_steps, evaluate_reward, evaluate_income, evaluate_accepted_order_number,
                evaluate_collected_POI_number, evaluate_total_data_vol, evaluate_total_data_utility))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--evaluate_freq", type=float, default=100 * 32,
    ...
    parser.add_argument("--K_epochs", type=int, default=15, help="GAE parameter")  # 设置为18，原先为15
    ...
    parser.add_argument("--add_agent_id", type=float, default=True,
    ...
    parser.add_argument("--region_n", type=int, default=35, help="Number of regions.")
    ...
    print("time limits:", args.episode_limit)
    runner = Runner_MAPPO(args, env_name="without_gnn_seed_{}_lr_{}_omega_{}_timelimits_{}".format(args.seed, args.lr,
                                                                                                   args.omega,
                                                                                                   args.episode_limit),
                          number=1)
    runner.run()